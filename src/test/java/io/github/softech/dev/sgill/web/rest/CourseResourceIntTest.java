...
public class CourseResourceIntTest {
    ...
    public void setup() {
        ...
        final CourseResource courseResource = new CourseResource(courseService, courseQueryService, customerRepository, courseHistoryRepository, customerService, courseCartBridgeRepository,
            courseCartBridgeService, cartService);
    ...
    public void getAllCoursesWithEagerRelationshipsIsEnabled() throws Exception {
        CourseResource courseResource = new CourseResource(courseServiceMock, courseQueryService, customerRepository, courseHistoryRepository, customerService, courseCartBridgeRepository,
            courseCartBridgeService, cartService);
